...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container my-5">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-2 col-sm-6">
                <div class="card text-center border-0 shadow-sm">
                    <div class="card-body">
                        <img src="images/formacao.png" alt="" class="mb-2" style="width: 40px;">
            ...
            <div class="col-md-2 col-sm-6">
                <div class="card text-center border-0 shadow-sm">
                    <div class="card-body">
                        <img src="images/campus.png" alt="" class="mb-2" style="width: 40px;">
            ...
            <div class="col-md-2 col-sm-6">
                <div class="card text-center border-0 shadow-sm">
                    <div class="card-body">
                        <img src="images/turnos.png" alt="" class="mb-2" style="width: 40px;">
                        <h6 class="card-title">Turnos</h6>
                        <p class="card-text small">Matutino <br> Vespertino</p>
                    </div>
                </div>
            </div>
            <!-- Card 5 -->
            <div class="col-md-2 col-sm-6">
                <div class="card text-center border-0 shadow-sm">
                    <div class="card-body">
                        <img src="images/duracao.png" alt="" class="mb-2" style="width: 40px;">
        ...
        <div class="content">
            ...
            <p>Role a página para ver o card fixo acompanhando.</p>
            <!-- Conteúdo extra para rolagem -->
  ...
  <div class="fixed-card" id="card">
    ...
    <h2>Graduação</h2>
    <p id="original-price"><s>De R$ 1599,85/mês</s></p>
    <p class="price">Por apenas <span id="price">R$ 575,00/mês</span></p>
    ...
    <!-- Botão -->
    <a href="#" class="subscribe-btn">Fazer Inscrição</a>
  </div>
